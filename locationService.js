    ...
    <div className="service-row">
      <div className="service-inner-row">
        ...
        <div className="column-right">
          ...
          <pre contenteditable="false" className="code-block-examples w-code-block" style="display:block;overflow-x:auto;background:#2b2b2b;color:#f8f8f2;padding:0.5em">
            <code className="language-javascript" style="white-space:pre">{log}</code>
          </pre>
        </div>
      </div>
    </div>
